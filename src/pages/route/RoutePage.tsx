...
export default function RoutePage() {
    ...
    const originName = state?.originName;;
    const destName = state?.destName;
            ...
            <div className="mx-4 mt-4 bg-white rounded-2xl shadow-md p-4">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[15px] font-medium text-gray-800">{originName}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[15px] font-medium text-gray-800">{destName}</span>
                    </div>
            ...
            <div className="flex justify-center gap-3 mt-5">
                {routeTabs.map((label, index) => (
                    <button
                        ...
                        className={`px-4 py-[6px] rounded-full border text-sm transition ${selectedIndex === index
